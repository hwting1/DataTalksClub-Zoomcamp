...
-- Deduplicate: keep the latest-extracted record per logical trip identity
-- within the incremental time window, clean invalid rows, and enrich with
-- the payment type lookup.
SELECT
