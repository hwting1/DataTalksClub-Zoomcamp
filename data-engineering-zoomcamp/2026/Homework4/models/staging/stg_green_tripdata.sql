...
renamed as (
    select
        ...
        TIMESTAMP_MICROS(SAFE_CAST(lpep_pickup_datetime / 1000 AS INT64)) AS pickup_datetime,
        TIMESTAMP_MICROS(SAFE_CAST(lpep_dropoff_datetime / 1000 AS INT64)) AS dropoff_datetime,
